(function () {
    ...
    if (getEmergencyRoomVisitsId) {
        ...
        var options = {
            colors: ['#605DFF', '#605DFF', '#605DFF', '#605DFF', '#605DFF', '#605DFF', '#605DFF', '#605DFF', '#605DFF'],
            plotOptions: {
                heatmap: {
                    shadeIntensity: 1,
                },
            ...
            xaxis: {
                ...
                categories: ['W1', 'W2', 'W3', 'W4', 'W5', 'W6', 'W7', 'W8', 'W9', 'W10', 'W11', 'W12', 'W13', 'W14', 'W15', 'W16', 'W17', 'W18', 'W19', 'W20'],
            },
            yaxis: {
                labels: {
                    show: true,
    ...
    if (getInstagramSubscriberId) {
        var options = {
            ...
            colors: ['#605DFF', '#9CAAFF', '#DDE4FF'],
            xaxis: {
                categories: ['Oct 01', 'Oct 02', 'Oct 03', 'Oct 04', 'Oct 05', 'Oct 06', 'Oct 07', 'Oct 07', 'Oct 08', 'Oct 09'],
                axisTicks: {
                    show: false,
                    color: '#8695AA',
                },
    ...
    if (getActiveUsersId) {
        var options = {
            ...
            xaxis: {
                categories: ['Oct 01', 'Oct 02', 'Oct 03', 'Oct 04', 'Oct 05', 'Oct 06', 'Oct 07', 'Oct 08', 'Oct 09', 'Oct 10'],
                axisTicks: {
                    show: false,
                    color: '#ECEEF2',
                },
    ...
    if (getGrossRevenueId) {
        var options = {
            ...
            xaxis: {
                categories: ['Oct 01', 'Oct 04', 'Oct 08', 'Oct 12', 'Oct 16', 'Oct 20', 'Oct 24', 'Oct 28', 'Nov 02', 'Nov 06'],
                axisTicks: {
                    show: false,
                    color: '#B1BBC8',
                },
    ...
    if (getPatientRetentionId) {
        var options = {
            ...
            xaxis: {
                categories: ['Oct', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11'],
                axisTicks: {
                    show: true,
                    color: '#E0E0E0',
                },
    ...
    if (getIncomeVsExpenseId) {
        var options = {
            ...
            xaxis: {
                categories: ['Oct 01', 'Oct 02', 'Oct 03', 'Oct 04', 'Oct 05', 'Oct 06', 'Oct 07', 'Oct 08', 'Oct 09'],
                axisTicks: {
                    show: false,
                    color: '#8695AA',
                },
    ...
    if (getCardWithAmountChartId) {
        var options = {
            ...
            xaxis: {
                categories: ['Rewards Card', 'Cashback Card', 'Travel Card', 'Student Card', 'Business Card'],
                axisTicks: {
                    show: true,
                    color: '#ECEEF2',
                },
    ...
    if (getIndividualAssetPerformanceId) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_1'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance2Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_2'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance3Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_3'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance4Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_4'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance5Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_5'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance6Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_6'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance7Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_7'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance8Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_8'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance9Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_9'), options);
        chart.render();
    }
    ...
    if (getIndividualAssetPerformance10Id) {
        var options = {
            ...
            chart = new ApexCharts(document.querySelector('#individual_asset_performance_chart_10'), options);
        chart.render();
    }

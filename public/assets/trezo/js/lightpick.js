...
(function (root, factory) {
    ...
    var document = window.document,
        ...
        renderDay = function (opts, date, dummy, extraClass) {
            ...
            var day = { time: moment(date).valueOf(), className: ['lightpick__day', 'is-available'] };
        ...
        updateDates = function (el, opts) {
            ...
            [].forEach.call(days, function (day) {
                day.outerHTML = renderDay(opts, parseInt(day.getAttribute('data-time')), !1, day.className.split(' '));
            });
        ...
        Lightpick = function (options) {
            ...
            self.el.addEventListener('mousedown', self._onMouseDown, !0);
            self.el.addEventListener('mouseenter', self._onMouseEnter, !0);
            self.el.addEventListener('touchend', self._onMouseDown, !0);
            self.el.addEventListener('change', self._onChange, !0);
            if (opts.inline) {
                self.show();
            } else {
                self.hide();
    ...
    Lightpick.prototype = {
        ...
        setDateRange: function (start, end, preventOnSelect) {
            ...
            this.setStartDate(start, !0);
            this.setEndDate(end, !0);
            if (this.isShowing) {
                updateDates(this.el, this._opts);
            }
            if (!preventOnSelect && typeof this._opts.onSelect === 'function') {

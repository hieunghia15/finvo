...
!(function (t, e) {
    ...
    var b,
        ...
        j = g(function (t) {
            ...
            })('versions', []).push({ version: '3.0.1', mode: 'global', copyright: 'ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© 2019 Denis Pushkarev (zloirock.ru)' });
        }),
        C = 0,
        N = Math.random(),
        z = function (t) {
        ...
        function t(e, i) {
            ...
            ((this.onScroll = function () {
                ...
                (this.drag = function (e) {
                    ...
                    var o =
                        ((('y' === r.draggedAxis ? e.pageY : e.pageX) - i.rect[r.axis[r.draggedAxis].offsetAttr] - r.axis[r.draggedAxis].dragOffset) / i.rect[r.axis[r.draggedAxis].sizeAttr]) *
                        r.contentWrapperEl[r.axis[r.draggedAxis].scrollSizeAttr];
                    ('x' === r.draggedAxis && ((o = r.isRtl && t.getRtlHelpers().isRtlScrollbarInverted ? o - (n + s.size) : o), (o = r.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -o : o)),

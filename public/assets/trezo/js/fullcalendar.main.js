...
var FullCalendar = (function (e) {
            ...
            e: if ('function' == typeof _) {
                if (
                    ...
                    r.__c
                        ...
                        : ('prototype' in _ && _.prototype.render ? (t.__c = u = new _(b, S)) : ((t.__c = u = new A(b, S)), (u.constructor = _), (u.render = z)),
                          E && E.sub(u),
                          (u.props = b),
                          u.state || (u.state = {}),
                          (u.context = S),
    ...
    function Je(e) {
        ((e.style.userSelect = 'none'), (e.style.webkitUserSelect = 'none'), e.addEventListener('selectstart', We));
    }
    function Ke(e) {
        ((e.style.userSelect = ''), (e.style.webkitUserSelect = ''), e.removeEventListener('selectstart', We));
    }
    function et(e) {
    ...
    class en {
        constructor(e) {
            ...
            ((this.standardDateProps = t), (this.extendedSettings = n), (this.smallestUnitNum = r), (this.buildFormattingFunc = Gt(tn)));
        }
        format(e, t) {
    ...
    class qn extends Gn {
        ...
        triggerCustomRendering(e) {
            ...
            if (i) {
                ...
                r &&
                    i(
                        Object.assign(Object.assign({ id: this.id, isActive: e, containerEl: this.base, reportNewContainerEl: this.updateElRef, generatorMeta: r }, n), {
    ...
    const vr = { id: String, groupId: String, title: String, url: String, interactive: Boolean },
        yr = { start: yn, end: yn, date: yn, allDay: Boolean },
        br = Object.assign(Object.assign(Object.assign({}, vr), yr), { extendedProps: yn });
    ...
    const Mr = {
        ...
        Ir = { display: null, startEditable: null, durationEditable: null, constraints: [], overlap: null, allows: [], backgroundColor: '', borderColor: '', textColor: '', classNames: [] };
    function Or(e, t) {
        let n = (function (e, t) {
    ...
    const Hr = { id: String, defaultAllDay: Boolean, url: String, format: String, events: yn, eventDataTransform: yn, success: yn, failure: yn };
    ...
    const Gr = { startTime: '09:00', endTime: '17:00', daysOfWeek: [1, 2, 3, 4, 5], display: 'inverse-background', classNames: 'fc-non-business', groupId: '_businessHours' };
    function Qr(e, t) {
        return wr(
            (function (e) {
                let t;
    ...
    function qr(e, t, n) {
        n.emitter.trigger('select', Object.assign(Object.assign({}, Yr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view }));
    }
    function Yr(e, t) {
        let n = {};
        for (let r of t.pluginHooks.dateSpanTransforms) Object.assign(n, r(e, t));
        var r, i;
        return (Object.assign(n, ((r = e), (i = t.dateEnv), Object.assign(Object.assign({}, Ai(r.range, i, r.allDay)), { allDay: r.allDay }))), n);
    }
    function Zr(e, t, n) {
    ...
    function Jr(e, t, n, r, i) {
        ...
        return (
            ...
            a && (l.range = { start: l.range.start, end: Zr(t.allDay, l.range.start, i) }),
    ...
    class ei {
        ...
        setProp(e, t) {
            if (e in yr) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
            else if ('id' === e) ((t = vr[e](t)), this.mutate({ standardProps: { publicId: t } }));
            else if (e in vr) ((t = vr[e](t)), this.mutate({ standardProps: { [e]: t } }));
            else if (e in Mr) {
                let n = Mr[e](t);
    ...
    function li(e, t) {
        let n = [];
        return (t[''] && n.push(t['']), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Nr(n));
    }
    function ci(e, t) {
        let n = e.map(di);
    ...
    function yi(e, t) {
        ...
        return (
            ...
            a
                ? qe((e) => {
                      s.trigger('eventClick', { el: e.target, event: new ei(t, n, r), jsEvent: e, view: t.viewApi });
                  })
                : {}
        );
    }
    ...
    class Oi extends A {
        ...
        computeTiming() {
            ...
            return ((i = Math.min(864e5, i)), { state: { nowDate: r, todayRange: Ni(r) }, waitMs: i });
        }
    ...
    class Pi {
        ...
        today() {
            let e = this.getCurrentData();
            (this.unselect(), this.dispatch({ type: 'CHANGE_DATE', dateMarker: e.nowManager.getDateMarker() }));
        }
        gotoDate(e) {
        ...
        addEvent(e, t) {
            if (e instanceof ei) {
                let t = e._def,
                    n = e._instance;
                return (this.getCurrentData().eventStore.defs[t.defId] || (this.dispatch({ type: 'ADD_EVENTS', eventStore: Cr({ def: t, instance: n }) }), this.triggerEventAdd(e)), e);
            }
            let n,
            ...
            if (i) {
                ...
                return (this.dispatch({ type: 'ADD_EVENTS', eventStore: Cr(i) }), this.triggerEventAdd(e), e);
            }
            return null;
        }
        triggerEventAdd(e) {
        ...
        addEventSource(e) {
            let t = this.getCurrentData();
            if (e instanceof Kr) return (t.eventSources[e.internalEventSource.sourceId] || this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [e.internalEventSource] }), e);
            let n = Br(e, t);
            return n ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [n] }), new Kr(t, n)) : null;
        }
        ...
        _splitInteraction(e) {
            ...
            if (e) {
                let n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                    ...
                    s = (r) => {
                        t[r] || (t[r] = { affectedEvents: n[r] || Li, mutatedEvents: i[r] || Li, isEvent: e.isEvent });
                    };
                for (let e in n) s(e);
                for (let e in i) s(e);
            }
    ...
    function es(e, t = !1) {
        ...
        return (
            $i() && 'rtl' === n.direction ? (c.scrollbarLeft = l) : (c.scrollbarRight = l),
            t &&
    ...
    class ds {
        ...
        handleInvalidInsertion(e, t, n) {
            if (this.allowReslicing && e.touchingEntry) {
                const r = Object.assign(Object.assign({}, t), { span: gs(t.span, e.touchingEntry.span) });
        ...
        insertEntryAt(e, t) {
            ...
            (-1 === t.lateral ? (ps(r, t.level, t.levelCoord), ps(n, t.level, [e])) : ps(n[t.level], t.lateral, e), (this.stackCnts[hs(e)] = t.stackCnt));
        }
        findInsertion(e) {
            ...
            for (let u = 0; u < s; u += 1) {
                ...
                for (; (h = f[p]) && h.span.start < e.span.end;) {
                    ...
                    (e > o && ((o = e), (c = h), (a = u), (l = p)), e === o && (d = Math.max(d, i[hs(h)] + 1)), (p += 1));
                }
            }
            let u = 0;
            if (c) for (u = a + 1; u < s && t[u] < o;) u += 1;
            let h = -1;
            return (u < s && t[u] === o && (h = ms(n[u], e.span.end, us)[0]), { touchingLevel: a, touchingLateral: l, touchingEntry: c, stackCnt: d, levelCoord: o, level: u, lateral: h });
        }
        toRects() {
    ...
    function fs(e) {
        ...
        for (let i of e) {
            ...
            for (let i of t)
                gs(i.span, s.span) ? (s = { entries: i.entries.concat(s.entries), span: ((n = i.span), (r = s.span), { start: Math.min(n.start, r.start), end: Math.max(n.end, r.end) }) }) : e.push(i);
            (e.push(s), (t = e));
        }
        var n, r;
        return t;
    ...
    class ws extends Gn {
        render() {
            ...
            let h = Object.assign(Object.assign(Object.assign({ date: u, view: r }, i.extraRenderProps), { text: c }), a);
            return p(
                Jn,
                {
                    elTag: 'th',
                    elClasses: l,
                    elAttrs: Object.assign({ role: 'columnheader', colSpan: i.colSpan, 'data-date': a.isDisabled ? void 0 : Lt(s) }, i.extraDataAttrs),
                    renderProps: h,
            ...
            return p(
                ...
                (n) =>
                    p(
                        ...
                        p(n, { elTag: 'a', elClasses: ['fc-col-header-cell-cushion', e.isSticky && 'fc-sticky'], elAttrs: { 'aria-label': t.format(s, Cs) } })
                    )
            );
        }
    }
        ...
        render() {
            ...
            return p(Oi, { unit: 'day' }, (e, o) =>
                p(
                    ...
                    t.map((e) =>
                        r
                            ? p(ws, { key: e.toISOString(), date: e, dateProfile: n, todayRange: o, colCnt: t.length, dayHeaderFormat: s })
                            : p(Rs, { key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: s })
                    )
                )
            );
        }
        ...
        _sliceDateSpan(e, t, n, r, i, ...s) {
            ...
            if (a) {
                let t = (function (e, t, n) {
                        ...
                        return { def: i, ui: li(i, t), instance: gr(i.defId, e.range), range: e.range, isStart: !0, isEnd: !0 };
                    ...
                    for (let r in l) {
                        ...
                        for (let e in h) {
                            ...
                            if (or(g, n.range)) {
                                ...
                                if (y && !y(new ei(t, u[n.defId], n), new ei(t, m, o))) return !1;
                            }
                        }
                        let b = i.eventStore;
                        for (let e of p.allows) {
                            let i,
                                ...
                                a = b.defs[m.defId],
                                l = b.instances[r];
                            if (((i = a ? new ei(t, a, l) : new ei(t, m)), !e(Yr(s, t), i))) return !1;
                        }
                    }
                    return !0;
                })(e, t, n, r)
    ...
    function Zs(e, t) {
        ...
        for (let r of e) {
            let e = r.span || 1;
            for (let i = 0; i < e; i += 1) n.push(p('col', { style: { width: 'shrink' === r.width ? Xs(t) : r.width || '', minWidth: r.minWidth || '' } }));
        }
        return p('colgroup', {}, ...n);
    }
    function Xs(e) {
    ...
    class ro extends Gn {
        ...
        renderSection(e, t, n) {
            return 'outerContent' in e
                ...
                : p('tr', { key: e.key, role: 'presentation', className: Ks(e, this.props.liquid).join(' ') }, this.renderChunkTd(e, t, e.chunk, n));
        }
    ...
    class so extends Gn {
        render() {
            ...
            return p(
                io,
                Object.assign({}, e, { elTag: 'a', elStyle: { borderColor: i.borderColor, backgroundColor: i.backgroundColor }, elAttrs: yi(r, t), defaultGenerator: oo, timeText: s }),
                (e, t) =>
                    p(
                        y,
                        null,
        ...
        render() {
            ...
            return p(
                ...
                Object.assign({}, e, {
                    ...
                    elAttrs: Object.assign(Object.assign({}, e.elAttrs), r.isDisabled ? {} : { 'data-date': Lt(e.date) }),
                    renderProps: r,
    ...
    class bo extends cs {
        ...
        render() {
            ...
            return p(co, { elRef: this.handleRootEl, date: r, dateProfile: s, todayRange: i }, (t, r, i) =>
                p(
                    yo,
                    {
                        elRef: i.ref,
                    ...
                    uo(e) && p(t, { elTag: 'div', elClasses: ['fc-more-popover-misc'] }),
                    n.children
                )
            );
        }
            ...
            (super(...arguments),
                ...
                (this.handleClick = (e) => {
                    ...
                    function s(e) {
                        ...
                        return { event: new ei(n, t, r), start: n.dateEnv.toDate(i.start), end: n.dateEnv.toDate(i.end), isStart: e.isStart, isEnd: e.isEnd };
                    }
    ...
    ((Bo.prototype.classes = { root: 'fc-theme-standard', tableCellShaded: 'fc-cell-shaded', buttonGroup: 'fc-button-group', button: 'fc-button fc-button-primary', buttonActive: 'fc-button-active' }),
        (Bo.prototype.baseIconClass = 'fc-icon'),
        (Bo.prototype.iconClasses = { close: 'fc-icon-x', prev: 'fc-icon-chevron-left', next: 'fc-icon-chevron-right', prevYear: 'fc-icon-chevrons-left', nextYear: 'fc-icon-chevrons-right' }),
        (Bo.prototype.rtlIconClasses = { prev: 'fc-icon-chevron-right', next: 'fc-icon-chevron-left', prevYear: 'fc-icon-chevrons-right', nextYear: 'fc-icon-chevrons-left' }),
    ...
    function ra(e, t, n, r, i) {
        return { header: e.headerToolbar ? ia(e.headerToolbar, e, t, n, r, i) : null, footer: e.footerToolbar ? ia(e.footerToolbar, e, t, n, r, i) : null };
    }
            ...
            eventSourceDefs: [
                {
                    ...
                    fetch(e, t, n) {
                        ...
                        wi(e.eventSource.meta.bind(null, Di(e.range, r)), (e) => t({ rawEvents: e }), n);
                    },
                },
            ],
        }),
                        ...
                        if (e.daysOfWeek || e.startTime || e.endTime || e.startRecur || e.endRecur) {
                            ...
                            return (
                                ...
                                !i &&
                                    ...
                                    ((n = e.endTime),
                                    (r = e.startTime),
                                    (i = { years: n.years - r.years, months: n.months - r.months, days: n.days - r.days, milliseconds: n.milliseconds - r.milliseconds })),
                    ...
                    expand(e, t, n) {
                        ...
                        return r
                            ? (function (e, t, n, r, i) {
                                  ...
                                  for (; o < a;) {
                                      let e;
                                      ((s && !s[o.getUTCDay()]) || ((e = t ? r.add(o, t) : o), l.push(r.createMarker(n.toDate(e)))), (o = wt(o, 1)));
                                  }
                                  return l;
    ...
    class ua {
        ...
        handleInput(e, t) {
            ...
            if (
                e !== n &&
                ('function' == typeof t ? (this.nowFn = t) : n || ((this.nowAnchorDate = e.toDate(t ? e.createMarker(t) : e.createNowMarker())), (this.nowAnchorQueried = Date.now())),
                (this.dateEnv = e),
                n)
            )
    ...
    class ha {
        constructor(e) {
            ...
            (Ea(c, s) && this.emitter.trigger('loading', !0), (this.state = c), this.updateData(), this.actionRunner.resume());
        }
        resetOptions(e, t) {
            let { props: n } = this;
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = mn([cn, e, t]),
                ...
                g = !1;
            for (let e in d)
                -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || (hn[e] && e in h && hn[e](h[e], d[e]))) ? (u[e] = f[e]) : l[e] ? ((u[e] = l[e](d[e])), (g = !0)) : (c[e] = h[e]);
            return (
    ...
    function ba(e) {
        ...
        return {
            ...
            selectionConfig: Or({ constraint: t.selectConstraint, overlap: 'boolean' == typeof t.selectOverlap ? t.selectOverlap : void 0, allow: t.selectAllow }, e),
        };
    }
    function Ea(e, t) {
                ...
                if ('title' === e) ((i = !1), r.push(p('h2', { className: 'fc-toolbar-title', id: t.titleId }, t.title)));
                    ...
                    (i && d.push(n.getClass('buttonActive')),
                        r.push(
                            p(
                                'button',
                                { type: 'button', title: 'function' == typeof c ? c(t.navUnit) : c, disabled: s, 'aria-pressed': i, className: d.join(' '), onClick: o },
            ...
            (super(e),
                (this.handleSegClick = (e, t) => {
                    ...
                    if (i && n.isValidSegDownEl(e.target)) {
                        ...
                        (r.emitter.trigger('eventClick', { el: t, event: new ei(n.context, i.eventRange.def, i.eventRange.instance), jsEvent: e, view: r.viewApi }),
    ...
    class xa extends ki {
        constructor(e) {
            (super(e),
                ...
                (this.handleSegEnter = (e, t) => {
                    oi(t) && ((this.currentSegEl = t), this.triggerEvent('eventMouseEnter', e, t));
                }),
        ...
        triggerEvent(e, t, n) {
            let { component: r } = this,
                { context: i } = r,
                s = oi(n);
            (t && !r.isValidSegDownEl(t.target)) || i.emitter.trigger(e, { el: n, event: new ei(i, s.eventRange.def, s.eventRange.instance), jsEvent: t, view: i.viewApi });
        }
    }
    class _a extends Vn {
        constructor() {
        ...
        render() {
            let e,
                ...
                i = !1,
                s = '';
            t.isHeightAuto || t.forPrint ? (s = '') : null != r.height ? (i = !0) : null != r.contentHeight ? (s = r.contentHeight) : (e = Math.max(r.aspectRatio, 0.5));
            ...
            return p(
                ...
                p(Oi, { unit: 'day' }, (r) => {
                    ...
                    return p(
                        y,
                        null,
                        n.header && p(wa, Object.assign({ ref: this.headerRef, extraClassName: 'fc-header-toolbar', model: n.header, titleId: a }, o)),
                        p(Ca, { liquid: i, height: s, aspectRatio: e, labeledById: a }, this.renderView(t), this.buildAppendContent()),
                        n.footer && p(wa, Object.assign({ ref: this.footerRef, extraClassName: 'fc-footer-toolbar', model: n.footer, titleId: '' }, o))
                    );
                })
            );
        }
        ...
        handleMove(e, t) {
            if (this.isEnabled) {
                ...
                (i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
                    ...
                    this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(La())));
            }
        }
        stop() {
            if (this.isEnabled) {
            ...
            (super(e),
                ...
                (this.onPointerDown = (e) => {
                    this.isDragging ||
                        ...
                        this.isInteracting &&
                            ...
                            (this.mirror.setIsVisible(!1), this.mirror.start(e.subjectEl, e.pageX, e.pageY), this.startDelay(e), this.minDistance || this.handleDistanceSurpassed(e)));
                }),
                (this.onPointerMove = (e) => {
                    if (this.isInteracting) {
                        ...
                        this.isDragging &&
                            ('scroll' !== e.origEvent.type && (this.mirror.handleMove(e.pageX, e.pageY), this.autoScroller.handleMove(e.pageX, e.pageY)), this.emitter.trigger('dragmove', e));
                    }
                }),
                (this.onPointerUp = (e) => {
                    this.isInteracting &&
    ...
    class Va {
        constructor(e) {
            ((this.el = e), (this.origRect = ns(e)), (this.scrollCaches = rs(e).map((e) => new za(e, !0))));
        }
        destroy() {
            for (let e of this.scrollCaches) e.destroy();
        }
        ...
        isWithinClipping(e, t) {
            let n = { left: e, top: t };
            for (let e of this.scrollCaches) if (!Ga(e.getEventTarget()) && !Hi(n, e.clientRect)) return !1;
            return !0;
        }
    }
    function Ga(e) {
            ...
            (super(e),
                ...
                (this.handleDragStart = (e) => {
                    ...
                    (e.isTouch ? r !== this.component.props.eventSelection && t.dispatch({ type: 'SELECT_EVENT', eventInstanceId: r }) : t.dispatch({ type: 'UNSELECT_EVENT' }),
                        this.isDragging &&
                            (t.calendarApi.unselect(e), t.emitter.trigger('eventDragStart', { el: this.subjectEl, event: new ei(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi })));
                }),
                        ...
                        i === s || (t.editable && t.droppable)
                            ? ((o = (function (e, t, n, r) {
                              ...
                              o &&
                                  ...
                                  (c.mutatedEvents = a),
                                  Os(c, e.dateProfile, s) || ((l = !0), (o = null), (a = null), (c.mutatedEvents = { defs: {}, instances: {} }))))
                            : (s = null);
                    }
                    ...
                    if (this.isDragging) {
                        ...
                        if ((this.clearDrag(), t.emitter.trigger('eventDragStop', { el: this.subjectEl, event: a, jsEvent: e.origEvent, view: n }), i)) {
                            if (r === t) {
                                ...
                                (t.emitter.trigger('eventDrop', Object.assign(Object.assign(Object.assign({}, d), u), { el: e.subjectEl, delta: i.datesDelta, jsEvent: e.origEvent, view: n })),
            ...
            class extends ki {
                constructor(e) {
                    (super(e),
                        ...
                        (this.handlePointerUp = (e) => {
                            this.dragSelection && (qr(this.dragSelection, e, this.component.context), (this.dragSelection = null));
                        }));
                    let { component: t } = e,
                        { options: n } = t.context,
                        r = (this.dragging = new Fa(e.el));
                    ...
                    (super(e),
                        ...
                        (this.handleDragStart = (e) => {
                            ...
                            ((this.draggingSegEl = r),
                                ...
                                t.emitter.trigger('eventResizeStart', { el: r, event: new ei(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi }));
                        }),
                        (this.handleHitUpdate = (e, t, n) => {
                            ...
                            (a && ((l = Xr(i, r.getCurrentData().eventUiBases, a, r)), (d.mutatedEvents = l), Os(d, e.dateProfile, r) || ((c = !0), (a = null), (l = null), (d.mutatedEvents = null))),
    ...
    class tl extends cs {
        ...
        renderSimpleLayout(e, t) {
            ...
            return (
                ...
                p(er, { elClasses: ['fc-daygrid'], viewSpec: r.viewSpec }, p(ro, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: i }))
            );
        }
        renderHScrollLayout(e, t, n, r) {
            ...
            return (
                ...
                l && c.push({ type: 'footer', key: 'footer', isSticky: !0, chunks: [{ key: 'main', content: eo }] }),
                p(
                    er,
                    { elClasses: ['fc-daygrid'], viewSpec: o.viewSpec },
                    p(i, { liquid: !s.isHeightAuto && !s.forPrint, forPrint: s.forPrint, collapsibleWidth: s.forPrint, colGroups: [{ cols: [{ span: n, minWidth: r }] }], sections: c })
                )
            );
        }
    }
                    ...
                    return p(
                        ...
                        t.map((t) => {
                            ...
                            return p(
                                ...
                                ol(t)
                                    ? p(ll, Object.assign({ seg: t, isDragging: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, pi(t, e.todayRange)))
                                    : p(
                                          al,
                                          Object.assign(
                                              { seg: t, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 },
                                              pi(t, e.todayRange)
                                          )
                                      )
                            );
            ...
            return p(
                ...
                (s, a) =>
                    p(
                        ...
                        t.showWeekNumber && p(mo, { elTag: 'a', elClasses: ['fc-daygrid-week-number'], elAttrs: Yi(e, o, 'week'), date: o, defaultFormat: hl }),
                        !a.isDisabled && (t.showDayNumber || uo(i) || t.forceDayTop)
                            ? p(
                                  'div',
                                  { className: 'fc-daygrid-day-top' },
                                  p(s, { elTag: 'a', elClasses: ['fc-daygrid-day-number', l && 'fc-daygrid-month-start'], elAttrs: Object.assign(Object.assign({}, Yi(e, o)), { id: n.dayNumberId }) })
                              )
                            : t.showDayNumber
            ...
            if (this.hiddenConsumes && s) {
                ...
                if (!i[e])
                    if (this.allowReslicing) {
                        const e = Object.assign(Object.assign({}, s), { span: gs(s.span, t.span) });
        ...
        render() {
            let { props: e, state: t, context: n } = this,
                ...
                l = rl(this.getMirrorSegs(), i),
                {
                    ...
                    moreCnts: u,
                    moreMarginTops: h,
                } = vl(ci(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells),
                    ...
                    (m && (a.isRtl ? ((y = 0), (v = c.lefts[t.lastCol] - c.lefts[t.firstCol])) : ((v = 0), (y = c.rights[t.firstCol] - c.rights[t.lastCol]))),
                        h.push(
                            p(
                                ...
                                ol(t)
                                    ? p(ll, Object.assign({ seg: t, isDragging: i, isSelected: f === l, defaultDisplayEventEnd: d }, pi(t, n)))
                                    : p(al, Object.assign({ seg: t, isDragging: i, isResizing: s, isDateSelecting: o, isSelected: f === l, defaultDisplayEventEnd: d }, pi(t, n)))
                            )
                        ));
                }
            return h;
        ...
        renderFillSegs(e, t) {
            ...
            if (i)
                for (let o of e) {
                    ...
                    s.push(p('div', { key: vi(o.eventRange), className: 'fc-daygrid-bg-harness', style: e }, 'bg-event' === t ? p(fo, Object.assign({ seg: o }, pi(o, r))) : po(t)));
                }
            return p(y, {}, ...s);
        }
        updateSizing(e) {
                ...
                if (e) {
                    ...
                    if (e.length) {
                        let t = this.rootElRef.current,
                            r = new is(t, e, !0, !1);
                        (n.framePositions && n.framePositions.similarTo(r)) || this.setState({ framePositions: new is(t, e, !0, !1) });
                    }
                }
                ...
                component: class extends tl {
                    ...
                    render() {
                        let { options: e, dateProfileGenerator: t } = this.context,
                            ...
                            i = e.dayHeaders && p(xs, { ref: this.headerRef, dateProfile: n.dateProfile, dates: r.headerDates, datesRepDistinctDays: 1 === r.rowCnt }),
                            s = (t) =>
                                p(Cl, {
                                    ref: this.tableRef,
            ...
            (super(...arguments),
                ...
                (this.renderHeadAxis = (e, t = '') => {
                    ...
                    return n.weekNumbers && 'day' === e
                        ? p(mo, { elTag: 'th', elClasses: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'], elAttrs: { 'aria-hidden': !0 }, date: i.start, defaultFormat: Pl }, (e) =>
                              p(
                                  'div',
        ...
        renderSimpleLayout(e, t, n) {
            ...
            return (
                ...
                p(
                    ...
                    p(ro, { liquid: !i.isHeightAuto && !i.forPrint, collapsibleWidth: i.forPrint, cols: [{ width: 'shrink' }], sections: s })
                )
            );
        }
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight &&
                    t.onCoords(new jl(new is(this.rootElRef.current, ((n = this.slatElRefs.currentMap), t.slatMetas.map((e) => n[e.key])), !1, !0), this.props.dateProfile, e.options.slotDuration));
            }
            var n;
        }
    }
    ...
    class Jl extends Gn {
        render() {
            return p(so, Object.assign({}, this.props, { elClasses: ['fc-timegrid-event', 'fc-v-event', this.props.isShort && 'fc-timegrid-event-short'], defaultTimeFormat: $l }));
        }
    }
    class Kl extends Gn {
        constructor() {
            ...
            return p(
                ...
                b.map((e) => {
                    ...
                    return p(
                        ...
                        p(Jl, Object.assign({ seg: o, isDragging: n, isResizing: r, isDateSelecting: i, isSelected: c === h, isShort: b }, pi(o, f, g)))
                    );
                })
            );
        }
        ...
        renderFillSegs(e, t) {
            let { props: n, context: r } = this,
                i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                    ...
                    return p(
                        'div',
                        { key: vi(s.eventRange), className: 'fc-timegrid-bg-harness', style: tc(r) },
                        'bg-event' === t ? p(fo, Object.assign({ seg: s }, pi(s, n.todayRange, n.nowDate))) : po(t)
                    );
                });
            return p(y, null, i);
        }
        ...
        return p(
            ...
            e.map((e) => {
                ...
                return p(
                    ...
                    p(Jl, Object.assign({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: i === r, isShort: !1 }, pi(e, t, n)))
                );
            })
        );
    }
    ...
    class nc extends Gn {
                                ...
                                p(
                                    ...
                                    p(
                                        ...
                                        p(
                                            'div',
                                            { className: 'fc-timegrid-now-indicator-container' },
                                            'number' == typeof n && p(ao, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: n }, isAxis: !0, date: e.nowDate })
                                        )
                                    )
                                ),
                            e.cells.map((t, n) =>
        ...
        updateCoords() {
            let { props: e } = this;
            var t;
            e.onColCoords && null !== e.clientWidth && e.onColCoords(new is(this.rootElRef.current, ((t = this.cellElRefs.currentMap), e.cells.map((e) => t[e.key])), !0, !1));
        }
    }
    class rc extends cs {
        constructor() {
                ...
                component: class extends Hl {
                    ...
                    render() {
                        let { options: e, dateEnv: t, dateProfileGenerator: n } = this.context,
                            ...
                            c = !l,
                            d = l,
                            u = e.dayHeaders && p(xs, { dates: s.headerDates, dateProfile: i, datesRepDistinctDays: !0, renderIntro: c ? this.renderHeadAxis : null }),
                            h =
                                !1 !== e.allDaySlot &&
                                ((t) =>
                                    p(
    ...
    class hc extends Gn {
        ...
        render() {
            let { theme: e, dateEnv: t, options: n, viewApi: r } = this.context,
                ...
                u = Object.assign({ date: t.toDate(s), view: r, textId: a, text: c, sideText: d, navLinkAttrs: Yi(this.context, s), sideNavLinkAttrs: Yi(this.context, s, 'day', !1) }, l);
            return p(
                Jn,
                {
                    elTag: 'tr',
                        ...
                        return p(Oi, { unit: 'day' }, (e, l) => {
                            ...
                            for (let n = 0; n < a.length; n += 1) {
                                ...
                                if (d) {
                                    let a = Lt(t[n]),
                                        u = o + '-' + a;
                                    (c.push(p(hc, { key: a, cellId: u, dayDate: t[n], todayRange: l })), (d = ci(d, r.eventOrder)));
                                    for (let t of d)
                                        c.push(
                                            p(
                                                pc,
                            ...
                            return p(
                                ...
                                p(
                                    'thead',
                                    null,
                                    p('tr', null, p('th', { scope: 'col', id: i }, r.timeHint), p('th', { scope: 'col', 'aria-hidden': !0 }), p('th', { scope: 'col', id: s }, r.eventHint))
                                ),
                                p('tbody', null, c)
                            );
                        });
    ...
    class Sc extends cs {
        constructor() {
            (super(...arguments), (this.buildDayTableModel = Gt(Rl)), (this.slicer = new wl()), (this.state = { labelId: Le() }));
        }
        render() {
            ...
            return p(
                ...
                p(
                    ...
                    p(
                        ...
                        p('thead', { role: 'rowgroup' }, p(xs, { dateProfile: e.dateProfile, dates: o.headerDates, datesRepDistinctDays: !1 }))
                    )
                ),
                p(
                    'div',
    ...
    return (
        ...
        (e.formatRange = function (e, t, n) {
            ...
            return s && o
                ? r.formatRange(s.marker, o.marker, i, { forcedStartTzo: s.forcedTzo, forcedEndTzo: o.forcedTzo, isEndExclusive: n.isEndExclusive, defaultSeparator: cn.defaultRangeSeparator })
                : '';
        }),
        (e.globalLocales = _o),
        (e.globalPlugins = la),
